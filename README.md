...
| [`qwen-image`](./skills/generative-media/qwen-image/) | Qwen-Image family (Alibaba Qwen) | Every open variant (T2I, Edit-2509/2511, 2512, Layered) plus the hosted 2.0/3.0 surface: the two-regime CFG rule, ComfyUI templates and quants, the Edit 1 MP-downscale bypass, bilingual text, ControlNet, diffusers, LoRA training, Edit-2511 as the no-training identity engine, Apache-2.0 |
